...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar Pais al que representa un atleta");
	...
	private void ejecutarBuscarPaisRepre()
	{
		System.out.println("\n" + "Pais al que representa un atleta" + "\n");
		
		String nombre_atleta = input("Ingrese el nombre del atleta: ");
		String pais = calculadora.buscarPaisRepre(nombre_atleta);
		System.out.println("\nEl nombre del pais al cual representa el atleta "+
							nombre_atleta+" es "+pais);	
	}

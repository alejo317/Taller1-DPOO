...
public class CalculadoraEstadisticas
{
	...
	public String buscarPaisRepre(String nombre)
	{
		Atleta nombreAtleta = buscarAtleta(nombre); 
		Pais elPais = null;
		String elPaisNombre = null;
		for (Atleta unAtleta : atletas)
		{
			if (unAtleta == nombreAtleta)
			{
				elPais = nombreAtleta.darPais();
				elPaisNombre = elPais.darNombre();
			}
		}
